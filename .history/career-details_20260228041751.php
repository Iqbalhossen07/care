                ...
                <div class="lg:col-span-5">
                        ...
                        <div
                            ...
                            <div class="relative z-10">
                                ...
                                <form action="#" method="POST" enctype="multipart/form-data" class="space-y-6">
                                    <div class="space-y-4">
                                        <div class="relative">
                                            ...
                                            <input type="text" placeholder="e.g. Sarah Jenkins" required
                                                class="w-full px-5 py-3.5 rounded-xl border border-gray-200 focus:border-brand focus:ring-4 focus:ring-brand/10 outline-none transition-all bg-lightBg/50 text-darkText font-medium placeholder:text-gray-400 placeholder:font-normal">
                                        </div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="email" placeholder="sarah@example.com" required
                                                class="w-full px-5 py-3.5 rounded-xl border border-gray-200 focus:border-brand focus:ring-4 focus:ring-brand/10 outline-none transition-all bg-lightBg/50 text-darkText font-medium placeholder:text-gray-400">
                                        </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="relative group/upload">
                                            ...
                                            <div
                                                ...
                                                <div
                                                    class="w-12 h-12 bg-white rounded-full shadow-sm flex items-center justify-center mx-auto mb-3 group-hover/upload:scale-110 transition-transform">
                                                ...
                                                <p class="text-sm font-bold text-darkText">Click to upload <span
                                                        class="text-gray-400 font-normal">or drag and drop</span></p>
                                                <p class="text-[10px] text-gray-400 mt-1 uppercase">PDF, DOC (Max 5MB)
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="pt-2">
                                        <button type="submit"
                                            class="w-full inline-flex items-center justify-center gap-3 px-6 py-4 border border-transparent text-base font-bold rounded-xl text-white bg-brand hover:bg-brandDark shadow-[0_20px_40px_-10px_rgba(140,212,36,0.3)] hover:shadow-[0_25px_50px_-10px_rgba(140,212,36,0.4)] transition-all duration-300 transform hover:-translate-y-1 active:scale-[0.98]">
                                            Send Application
                    ...
                    <div class="mt-6 flex items-center justify-center gap-6 opacity-60">
                        <div class="flex items-center gap-2">
                            ...
                            <span class="text-xs font-bold text-darkText uppercase tracking-tighter">Secure Data</span>
                        </div>
                        <div class="flex items-center gap-2">
                            <svg class="w-5 h-5 text-brand" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <span class="text-xs font-bold text-darkText uppercase tracking-tighter">GDPR
                                Compliant</span>
                        </div>
                    </div>
                </div>
