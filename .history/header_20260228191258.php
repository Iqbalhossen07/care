        ...
        <div class="px-5 sm:px-8">
            <div class="flex justify-between items-center h-20 md:h-24">
                ...
                <nav class="hidden md:flex space-x-8 items-center">
                    <a href="index.php"
                        class="<?php echo ($current_page == 'index.php') ? 'text-brand font-bold' : 'text-gray-800 font-medium hover:text-brand'; ?>
transition-all duration-200 py-1">Home</a>
...
<div class="md:hidden flex items-center">
    <button id="mobile-menu-btn" class="text-gray-800 hover:text-brand focus:outline-none p-2 bg-gray-50 rounded-lg">
