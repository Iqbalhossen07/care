    ...
    <div
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    <input id="remember-me" name="remember-me" type="checkbox"
                        class="h-4 w-4 text-brand focus:ring-brand border-gray-300 rounded cursor-pointer">
                ...
                <div class="text-sm">
                    <a href="#" class="font-bold text-brand hover:text-brandDark transition-colors">
                        Forgot password?
                    </a>
                </div>
            </div>
        ...
        <div class="text-center mt-6">
            <p class="text-xs text-gray-400">
                &copy; 2026 Community Careline Services (Medway) Ltd. <br>
