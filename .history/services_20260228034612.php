...
<body class="font-body text-gray-600 antialiased bg-white">
    ...
    <section class="relative h-[250px] flex items-center overflow-hidden bg-darkText">
        <div class="absolute inset-0 z-0">
            <img src="https://images.unsplash.com/photo-1586762524442-db59706294ad?auto=format&fit=crop&w=1500&q=80"
                class="w-full h-full object-cover opacity-40" alt="Services Background">
                ...
                <div
                    ...
                    <div class="flex-1 flex flex-col p-6">
                        <h3 class="font-heading text-2xl font-bold text-darkText mb-3 uppercase tracking-tight">Respite
                            Care Services</h3>
                        <p
                            class="text-gray-600 mb-8 text-sm md:text-base leading-relaxed flex-1 line-clamp-2 description">
                ...
                <div
                    ...
                    <div class="flex-1 flex flex-col p-6">
                        <h3 class="font-heading text-2xl font-bold text-darkText mb-3 uppercase tracking-tight">Home
                            Care Services</h3>
                        <p class="text-gray-600 mb-8 text-sm md:text-base leading-relaxed flex-1">
