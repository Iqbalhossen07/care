    ...
    <section class="py-20 bg-lightBg">
        <div class="max-w-7xl mx-auto px-6 lg:px-12">
            <div class="grid lg:grid-cols-2 gap-12 items-start">
                ...
                <div
                    class="relative h-[550px] lg:h-[600px] rounded-[2.5rem] overflow-hidden shadow-2xl shadow-black/10 border-8 border-white bg-gray-100">
                    <div id="googleMap" class="w-full h-full"></div>

                    <div class="absolute bottom-6 left-6 pointer-events-none z-20">
                        <div
                            class="bg-white/95 backdrop-blur-md p-4 rounded-2xl shadow-xl border border-white/50 flex items-center gap-3">
                            <div
                                class="w-10 h-10 bg-[#8CD424] rounded-xl flex items-center justify-center shadow-lg shadow-[#8CD424]/20">
