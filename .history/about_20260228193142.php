...
<body class="font-body text-gray-600 antialiased bg-white">
    ...
    <section class="relative h-[350px] flex items-center overflow-hidden bg-darkText ">
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-12 relative z-10 w-full  mt-20">
            ...
            <h1 class="font-heading text-4xl md:text-4xl font-bold text-white mb-2 tracking-tight">Our Mission & Heart
            </h1>
            ...
            <div class="space-y-4">
                ...
                $faqs = [
                    ...
                    [
                        ...
                        "a" => "Community Careline Services (Medway) Ltd adheres to GDPR regulations and the NHS Data Protection Toolkit, your personal information is kept securely and only those who need this information will have access to it. All our systems meet GDPR requirements when it comes to security."
                    ],
                    [
