        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-12">
            <div class="grid lg:grid-cols-12 gap-12 lg:gap-16">
                ...
                <div class="lg:col-span-8">
                    <div class="flex flex-wrap items-center gap-y-4 gap-x-8 mb-10 pb-8 border-b border-gray-100">
                        <div class="flex items-center gap-3 group">
                            <div
                                class="w-12 h-12 rounded-full bg-brand/10 flex items-center justify-center text-brand font-bold border border-brand/5 group-hover:bg-brand group-hover:text-white transition-all duration-300">
                                CE
                            </div>
                            <div>
                                <p class="text-[10px] uppercase font-bold text-gray-400 tracking-widest">Written by</p>
                                <p class="text-darkText font-bold text-sm">Careline Editor</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-8">
                            <div class="text-gray-500 text-sm flex items-center gap-2">
                                ...
                                <span class="font-medium">Feb 28, 2026</span>
                            </div>
                            <div class="text-gray-500 text-sm flex items-center gap-2">
                                <div class="w-8 h-8 rounded-lg bg-lightBg flex items-center justify-center">
                                    <svg class="w-4 h-4 text-brand" fill="none" stroke="currentColor"
                    ...
                    <div class="prose prose-lg max-w-none text-gray-600 leading-relaxed">
                        <div
                            class="relative py-10 px-8 md:px-12 bg-lightBg rounded-[2rem] border-l-[6px] border-brand mb-12 shadow-sm">
                            <svg class="absolute top-6 left-6 w-12 h-12 text-brand/10" fill="currentColor"
                                viewBox="0 0 32 32">
                                <path
                                    d="M10 8v8H6c0 4.418 3.582 8 8 8v4c-6.627 0-12-5.373-12-12V8h8zm18 0v8h-4c0 4.418 3.582 8 8 8v4c-6.627 0-12-5.373-12-12V8h8z">
                                </path>
                            </svg>
                            <p class="text-2xl font-heading font-bold text-darkText italic relative z-10 leading-snug">
                                "Mental health is just as important as physical health, especially for seniors living
                                independently. A healthy mind lead to a happier life."
                            </p>
                        </div>

                        <p
                            class="first-letter:text-6xl first-letter:font-bold first-letter:text-brand first-letter:mr-3 first-letter:float-left text-lg">
                            Maintaining mental wellbeing in later years is crucial for a high quality of life. As we
                            age, life transitions such as retirement, health changes, or losing loved ones can impact
                            our mental state. However, aging also brings wisdom and the opportunity for new experiences.
                        </p>

                        <div class="my-12 relative rounded-3xl overflow-hidden shadow-xl">
                            <img src="https://images.unsplash.com/photo-1581578731548-c64695cc6952?auto=format&fit=crop&w=1200&q=80"
                                alt="Seniors engaging" class="w-full h-80 object-cover">
                            <div
                                class="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/60 to-transparent">
                                <p class="text-white text-xs italic">Staying engaged and active is the key to longevity.
                                </p>
                            </div>
                        </div>

                        <h3 class="text-3xl font-heading font-bold text-darkText mt-12 mb-6 flex items-center gap-4">
                            <span
                                class="flex items-center justify-center w-10 h-10 rounded-full bg-brand text-white text-sm">01</span>
                            Stay Socially Active
                        </h3>
                        <p class="text-lg">
                            Isolation is one of the biggest risks to senior mental health. Regularly engaging with
                            friends, family, or community groups can reduce feelings of loneliness and boost mood.
                        </p>

                        <h3 class="text-3xl font-heading font-bold text-darkText mt-12 mb-6 flex items-center gap-4">
                            <span
                                class="flex items-center justify-center w-10 h-10 rounded-full bg-brand text-white text-sm">02</span>
                            Keep Your Mind Engaged
                        </h3>
                        <p class="text-lg">
                            Just like a muscle, the brain needs exercise. Reading, puzzles, learning a new hobby, or
                            even using technology to stay connected helps keep neural pathways active.
                        </p>

                        <div
                            class="group my-12 p-8 bg-darkText rounded-[2rem] text-white relative overflow-hidden transition-all duration-500 hover:shadow-2xl hover:shadow-brand/20">
                            <div
                                class="absolute -top-10 -right-10 w-32 h-32 bg-brand/20 rounded-full blur-3xl group-hover:bg-brand/40 transition-all">
                            </div>
                            <div class="relative z-10">
                                <div class="flex items-center gap-3 mb-4">
                                    <span
                                        class="px-3 py-1 bg-brand rounded-md text-[10px] font-bold uppercase tracking-widest">Health
                                        Insight</span>
                                </div>
                                <h4 class="text-xl font-bold mb-4">Did You Know?</h4>
                                <p class="text-gray-300 italic leading-relaxed">
                                    According to health research, regular social interaction can reduce the risk of
                                    cognitive decline by over <span class="text-brand font-bold text-xl">20%</span> in
                                    seniors.
                                </p>
                            </div>
                        </div>
                        ...
                        <p class="text-lg">
                            At <span class="text-brand font-extrabold uppercase tracking-tighter">Careline</span>, we
                            don't just provide physical care; our companions are trained to offer mental and emotional
                            support to ensure our clients feel valued and heard every single day.
                        </p>
                    </div>
                </div>
