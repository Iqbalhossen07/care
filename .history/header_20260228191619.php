...
<div class="fixed w-full top-4 md:top-6 z-50 px-4 md:px-8 flex justify-center pointer-events-none">
    <header
        class="w-full max-w-7xl bg-white/90 backdrop-blur-lg border border-white/60 shadow-[0_15px_40px_-10px_rgba(0,0,0,0.1)] rounded-md pointer-events-auto transition-all duration-300">
