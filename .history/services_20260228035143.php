            ...
            <div class="max-w-2xl mx-auto text-center relative z-10">
                ...
                <div class="flex flex-col sm:flex-row justify-center gap-4">
                    <a href="tel:0800123456"
                        class="bg-white text-darkText px-6 py-3 rounded-md font-bold text-sm md:text-base hover:bg-gray-100 transition-all shadow-lg shadow-black/20 transform hover:-translate-y-1 duration-300 flex items-center justify-center gap-2">
                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                            <path
                    ...
                    <a href="contact.php"
                        class="border-2 border-white text-white px-6 py-3 rounded-md font-bold text-sm md:text-base hover:bg-white hover:text-brand transition-all transform hover:-translate-y-1 duration-300">
                        Book Assessment
                    </a>
                </div>
            </div>
