       ...
       <header
           ...
           <div id="mobile-menu"
               ...
               <div class="px-5 pt-4 pb-6 space-y-2">
                   ...
                   <a href="contact.php"
                       class="block px-4 py-3 mt-4 text-base font-bold text-white bg-brand text-center rounded-xl shadow-md shadow-brand/20 hover:bg-brandDark transition-all duration-300">Apply
                       Now</a>
