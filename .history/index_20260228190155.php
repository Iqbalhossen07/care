...
<body class="font-body text-gray-600 antialiased bg-white">
    ...
    <div class="fixed w-full top-4 md:top-6 z-50 px-4 md:px-8 flex justify-center pointer-events-none">
        <header
            class="w-full max-w-7xl bg-white/90 backdrop-blur-lg border border-white/60 shadow-[0_15px_40px_-10px_rgba(0,0,0,0.1)] rounded-[2rem] pointer-events-auto transition-all duration-300">
            <div class="px-5 sm:px-8">
                <div class="flex justify-between items-center h-20 md:h-24">
                    ...
                    <nav class="hidden md:flex space-x-8 items-center">
                        ...
                        <a href="contact.php"
                            class="bg-brand text-white px-7 py-3 rounded-xl font-bold hover:bg-brandDark shadow-lg shadow-brand/30 hover:shadow-xl hover:shadow-brand/40 transition-all duration-300 transform hover:-translate-y-1">
                            Apply Now
                        </a>
                    </nav>
                ...
                <div
                    ...
                    <div class="max-w-2xl">
                        ...
                        <div class="flex flex-wrap gap-3 md:gap-4">
                            <a href="contact.php"
                                class="px-6 py-3 md:px-8 md:py-4 bg-brand text-white text-sm md:text-base font-bold rounded-xl shadow-lg shadow-brand/30 hover:bg-brandDark hover:-translate-y-1 transition-all duration-300">
                                Book Assessment
                            </a>
                            <a href="services.php"
