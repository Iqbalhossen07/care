...
<body class="font-body text-gray-600 antialiased bg-white">
    ...
    <section class="relative h-[250px] flex items-center overflow-hidden bg-darkText">
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-12 relative z-10 w-full">
            ...
            <h1 class="font-heading text-4xl md:text-5xl font-bold text-white mb-2 tracking-tight">Expert Care Insights
            </h1>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        filterBtns.forEach(btn => {
            btn.addEventListener('click', () => {
                // Update buttons
                filterBtns.forEach(b => b.classList.remove('bg-brand', 'text-white',
                    'shadow-lg', 'shadow-brand/20', 'border-brand'));
                filterBtns.forEach(b => b.classList.add('bg-white', 'text-darkText',
                    'border-gray-200'));
