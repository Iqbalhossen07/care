...
<body class="font-body text-gray-600 antialiased bg-white">
    ...
    <section class="relative h-[250px] flex items-center overflow-hidden bg-darkText">
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-12 relative z-10 w-full">
            ...
            <h1 class="font-heading text-4xl md:text-5xl font-bold text-white mb-2 tracking-tight">Respite Care Services
            </h1>
        </div>
    </section>
            ...
            <div class="grid lg:grid-cols-12 gap-12">
                ...
                <div class="lg:col-span-8">
                    <div
                        ...
                        <img src="https://images.unsplash.com/photo-1576765608866-5b51046452be?auto=format&fit=crop&w=1200&q=80"
                            alt="Respite Caregiving" class="w-full h-[400px] object-cover">
                    </div>
                ...
                <div class="lg:col-span-4">
                    <div class="sticky top-28 space-y-8">
                        ...
                        <div class="bg-darkText p-8 rounded-3xl text-white">
                            <h4 class="font-heading text-xl font-bold mb-4">Why Choose Us?</h4>
                            <ul class="space-y-3 text-sm text-gray-400">
                                <li class="flex items-center gap-2 italic">★★★★★ "Outstanding Service"</li>
                                <li>Registered with CQC UK</li>
                                <li>24/7 Professional Oversight</li>
                            </ul>
                        </div>
                    </div>
                </div>
