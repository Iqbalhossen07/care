     ...
     <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
         <div class="flex justify-between items-center h-20">
             ...
             <nav class="hidden md:flex space-x-8 items-center">
                 <a href="index.php" class="text-gray-700 hover:text-brand font-medium transition-colors">Home</a>
                 ...
                 <a href="careers.php" class="text-gray-700 hover:text-brand font-medium transition-colors">Why Us</a>
                 <a href="#contact"
