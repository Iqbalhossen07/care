    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-20">
            ...
            <nav class="hidden md:flex space-x-8 items-center">
                ...
                <a href="services.php"
                    class="<?php echo ($current_page == 'services.php'|| $current_page =='') ? 'text-brand font-bold border-b-2 border-brand' : 'text-gray-700 font-medium hover:text-brand'; ?> transition-all duration-200 py-1">Services</a>
