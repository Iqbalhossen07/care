        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-12">
            <div class="grid lg:grid-cols-2 gap-12 items-start">
                ...
                <div
                    ...
                    <iframe id="normal-map"
                        class="absolute inset-0 w-full h-full border-0 transition-opacity duration-500"
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2484.586221715423!2d0.6059371769352924!3d51.36151747178044!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47d8cd0604193b0b%3A0x7000000000000000!2s74%20High%20St%2C%20Rainham%2C%20Gillingham%20ME8%207JH%2C%20UK!5e0!3m2!1sen!2sbd!4v1709180000000!5m2!1sen!2sbd"
                        allowfullscreen="" loading="lazy"></iframe>

                    <iframe id="street-view-map"
                        class="absolute inset-0 w-full h-full border-0 opacity-0 pointer-events-none transition-opacity duration-500"
                        src="https://www.google.com/maps/@51.3615175,0.6085121,3a,75y,180h,90t/data=!3m6!1e1!3m4!1s-example-id!2e0!7i16384!8i8192"
                        allowfullscreen="" loading="lazy"></iframe>

                    <div class="absolute bottom-6 left-6 z-30">
                        <button id="map-switch-btn"
                            class="bg-white/95 backdrop-blur-md p-4 rounded-2xl shadow-xl border border-white/50 flex items-center gap-3 hover:scale-105 active:scale-95 transition-all group pointer-events-auto">
                            <div
                                class="w-10 h-10 bg-brand rounded-xl flex items-center justify-center shadow-lg shadow-brand/20 group-hover:bg-brandDark">
                                <img id="btn-icon" src="https://cdn-icons-png.flaticon.com/512/3448/3448651.png"
                                    class="w-6 h-6" alt="Pegman">
                            </div>
                            <div class="text-left">
                                <p id="btn-subtext"
                                    class="text-[10px] uppercase tracking-widest font-bold text-gray-400 leading-none mb-1">
                                    Interactive</p>
                                <p id="btn-text" class="text-sm font-bold text-darkText leading-none">Switch to Street
                                    View</p>
                            </div>
                        </button>
                    </div>
