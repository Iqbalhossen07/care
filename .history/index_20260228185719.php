...
<body class="font-body text-gray-600 antialiased bg-white">
    ...
    <header
        class="fixed w-full top-0 z-50 bg-white/60 backdrop-blur-md border-b border-white/50 shadow-[0_8px_30px_rgb(0,0,0,0.04)] transition-all duration-300">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <nav class="hidden md:flex space-x-8 items-center">
                    <a href="index.php"
                        class="<?php echo ($current_page == 'index.php') ? 'text-brand font-bold border-b-2 border-brand' : 'text-gray-800 font-medium hover:text-brand'; ?> transition-all duration-200 py-1">Home</a>

                    <a href="about.php"
                        class="<?php echo ($current_page == 'about.php') ? 'text-brand font-bold border-b-2 border-brand' : 'text-gray-800 font-medium hover:text-brand'; ?> transition-all duration-200 py-1">About
                        Us</a>

                    <a href="services.php"
                        class="<?php echo ($current_page == 'services.php' || $current_page == 'service-details.php') ? 'text-brand font-bold border-b-2 border-brand' : 'text-gray-800 font-medium hover:text-brand'; ?> transition-all duration-200 py-1">Services</a>

                    <a href="careers.php"
                        class="<?php echo ($current_page == 'careers.php' || $current_page == 'career-details.php') ? 'text-brand font-bold border-b-2 border-brand' : 'text-gray-800 font-medium hover:text-brand'; ?> transition-all duration-200 py-1">Careers</a>

                    <a href="blogs.php"
                        class="<?php echo ($current_page == 'blogs.php' || $current_page == 'blog-details.php') ? 'text-brand font-bold border-b-2 border-brand' : 'text-gray-800 font-medium hover:text-brand'; ?> transition-all duration-200 py-1">Blogs</a>

                    <a href="contact.php"
                        class="bg-brand text-white px-6 py-2.5 rounded-xl font-bold hover:bg-brandDark shadow-lg shadow-brand/30 hover:shadow-xl hover:shadow-brand/40 transition-all duration-300 transform hover:-translate-y-1">
                        Contact Us
                    </a>
                </nav>

                <div class="md:hidden flex items-center">
                    <button id="mobile-menu-btn" class="text-gray-800 hover:text-brand focus:outline-none p-2">
        ...
        <div id="mobile-menu"
            class="hidden md:hidden bg-white/95 backdrop-blur-md border-t border-gray-100 absolute w-full shadow-2xl">
            <div class="px-4 pt-2 pb-6 space-y-2">
            </div>
        </div>
    </header>

    <section id="home" class="relative h-[100vh] min-h-[650px] overflow-hidden bg-darkText">

        <div id="hero-slider" class="relative w-full h-full">

            <div class="slide absolute inset-0 w-full h-full transition-opacity duration-1000 opacity-100 z-10">
                <img src="img/hero1.jpg" alt="Caregiver" class="absolute inset-0 w-full h-full object-cover">
                <div class="absolute inset-0 bg-gradient-to-r from-black/80 via-black/50 to-transparent"></div>

                <div
                    class="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex flex-col justify-center pt-20">
                    <div class="max-w-2xl">
                        <span
                            class="inline-flex items-center gap-2 text-white font-bold tracking-widest uppercase text-xs px-4 py-2 bg-brand/90 backdrop-blur-sm rounded-full mb-6 shadow-lg">
                            Trusted UK Care Providers
                        </span>
                        <h1
                            class="font-heading text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-[1.1]">
                        ...
                        <div class="flex flex-wrap gap-4">
                            <a href="contact.php"
                                class="px-8 py-4 bg-brand text-white font-bold rounded-xl shadow-lg shadow-brand/30 hover:bg-brandDark hover:-translate-y-1 transition-all duration-300">
                                Book Assessment
                            </a>
                            <a href="services.php"
                                class="px-8 py-4 bg-white/10 backdrop-blur-md border border-white/30 text-white font-bold rounded-xl hover:bg-white hover:text-darkText hover:-translate-y-1 transition-all duration-300">
                                Our Services
                            </a>
                        </div>
                    </div>
            ...
            <div class="slide absolute inset-0 w-full h-full transition-opacity duration-1000 opacity-0 z-0">
                <img src="https://images.unsplash.com/photo-1576765608535-5f04d1e3f289?auto=format&fit=crop&w=1500&q=80"
                    alt="Professional Care" class="absolute inset-0 w-full h-full object-cover">
                <div class="absolute inset-0 bg-gradient-to-r from-black/80 via-black/50 to-transparent"></div>
                ...
                <div
                    ...
                    <div class="max-w-2xl">
                        ...
                        <h1
                            class="font-heading text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-[1.1]">
                            Experienced care <span class="text-brand">you can trust</span>.
                        </h1>
                        <p class="text-lg md:text-xl text-gray-200 mb-8 leading-relaxed">
                            Our team is highly trained and fully vetted, bringing you peace of mind and the highest
                            standard of daily living support.
                        </p>
                        <div class="flex flex-wrap gap-4">
                            <a href="contact.php"
                                class="px-8 py-4 bg-brand text-white font-bold rounded-xl shadow-lg shadow-brand/30 hover:bg-brandDark hover:-translate-y-1 transition-all duration-300">
